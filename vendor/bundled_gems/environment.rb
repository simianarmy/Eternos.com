...
module Bundler
 ...
 dir = File.dirname(file)
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/bullet-1.7.4/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/gdata-1.1.1/bin")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/facebooker-1.0.61/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/facebooker-1.0.61/lib")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/shuber-encryptor-1.0.1/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/shuber-encryptor-1.0.1/lib")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/shuber-eigenclass-1.0.1/bin")
  ...
  @bundled_specs["bullet"].loaded_from = "#{dir}/specifications/bullet-1.7.4.gemspec"
  @bundled_specs["gdata"] = eval(File.read("#{dir}/specifications/gdata-1.1.1.gemspec"))
  @bundled_specs["gdata"].loaded_from = "#{dir}/specifications/gdata-1.1.1.gemspec"
  ...
  @bundled_specs["facebooker"] = eval(File.read("#{dir}/specifications/facebooker-1.0.61.gemspec"))
  @bundled_specs["facebooker"].loaded_from = "#{dir}/specifications/facebooker-1.0.61.gemspec"
  ...
  @bundled_specs["shuber-encryptor"] = eval(File.read("#{dir}/specifications/shuber-encryptor-1.0.1.gemspec"))
  @bundled_specs["shuber-encryptor"].loaded_from = "#{dir}/specifications/shuber-encryptor-1.0.1.gemspec"
  ...
  @bundled_specs["shuber-eigenclass"] = eval(File.read("#{dir}/specifications/shuber-eigenclass-1.0.1.gemspec"))
