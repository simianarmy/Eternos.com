module Technoweenie # :nodoc:
  module AttachmentFu # :nodoc:
    # breaks mp3 & video uploads - commenting out default processors fixes things...
    ...
    mattr_reader :image_content_types, :tempfile_path, :default_processors
      ...
      protected
        ...
        def attachment_attributes_valid?
          [:size, :content_type].each do |attr_name|
            ...
            errors.add attr_name, I18n.t(:inclusion, :scope => 'activerecord.errors.messages') unless enum.nil? || enum.include?(send(attr_name))
          end
        end
        ...
        def process_attachment
          logger.debug "AttachmentFu::process_attachment"
