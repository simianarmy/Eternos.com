namespace :js do
  ...
  task :min_lib => :environment do
    ...
    collection = {
      ...
      "#{lib_cache_dir}vault_dashboard.js" => [
        "#{lib_global_dir}curvycorners.js",
        "#{lib_global_dir}jQuery/jquerytools-1.1.2.min.js", 
        "#{lib_global_dir}application_jquery.js",
        "#{lib_global_dir}prototype.js", 
        "#{lib_global_dir}scriptaculous.js",
      ...
      "#{lib_cache_dir}vault_account_setup.js" => [
        "#{lib_global_dir}curvycorners.js",
        "#{lib_global_dir}jQuery/jquerytools-1.1.2.min.js", 
        "#{lib_global_dir}application_jquery.js",
        "#{lib_global_dir}prototype.js", 
      ...
      "#{lib_cache_dir}vault_account.js" => [
        "#{lib_global_dir}curvycorners.js",
        "#{lib_global_dir}jQuery/jquerytools-1.1.2.min.js", 
        "#{lib_global_dir}application_jquery.js",
        "#{lib_global_dir}prototype.js", 
      ...
      "#{lib_cache_dir}vault_billing.js" => [
        "#{lib_global_dir}curvycorners.js",
        "#{lib_global_dir}jQuery/jquerytools-1.1.2.min.js", 
        "#{lib_global_dir}application_jquery.js",
        "#{lib_global_dir}prototype.js", 
