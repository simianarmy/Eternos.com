 ...
 *
 * $Id$
 * Modified to allow more css inside wrap element around each clip link
 * by changing the selector from $(wrap.selector + "> *") to 
 * $(wrap.selector + "a.playlist_clip")
 *
 * Requires all <a> tags inside playlist to have class = "playlist_clip" to be 
 * playable in Playlist
 *
 */ 
(function($) {
...
//}}}  
		...
		// manual playlist
			...
			if ($.isFunction(els.live)) {
				$(wrap.selector + " a.playlist_clip").live("click", function() {
					var el = $(this);
