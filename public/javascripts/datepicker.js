/*
        DatePicker v4.1 by frequency-decoder.com
...
var datePickerController = (function datePickerController() {
                        ...
                        switch(key.toLowerCase()) { 
                                ...
                                case "formats":                                                 
                                        if(typeof value === 'object') {
                                                if(value.length) {
                                                        var tmpMasks = [];
                                                        for(var m = 0, msk; msk = value[m]; msk++) {
        ...
        function parseCellFormat(value) {                  
                // I'm sure this could be done with a regExp and a split in one line...
        ...
        var getDayTranslation = function(day, abbreviation) {
                ...
                return titles && titles.length && titles.length > day ? titles[day] : "";
        };
        var getMonthTranslation = function(month, abbreviation) {
                var titles = localeImport[abbreviation ? "monthAbbrs" : "fullMonths"];
                return titles && titles.length && titles.length > month ? titles[month] : "";
        };
